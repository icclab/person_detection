...
class ImagePublisher(Node):
    def __init__(self):
        ...
        self.declare_parameter("image_folder", "/home/icc-nano/energy_ws/src/test_person_1/")
        self.declare_parameter("csv_file", "/home/icc-nano/energy_ws/src/workload_1.csv")
        self.declare_parameter("compress", 80) 
    ...
    def timer_callback(self):
        ...
        self.get_logger().info(
            f'[{self.current_freq} Hz] Published image {self.image_index + 1}: {os.path.basename(img_path)[0]}'
        )
        ...
        ros_image.header.frame_id = log_name[0] + "," + log_name + "," + str(self.compress) + "," + str(self.current_freq)
