...
class YoloV8nNode(Node):
    def __init__(self):
        super().__init__('yolov8n_raw_node')

        qos = QoSProfile(
            depth=10,
            reliability=ReliabilityPolicy.RELIABLE
        )
        self.subscription = self.create_subscription(Image, '/oak/rgb/image_raw', self.listener_callback, qos)
    ...
    def listener_callback(self, msg):
        ...
        detections_msg.payload_bytes = len(msg.data)
