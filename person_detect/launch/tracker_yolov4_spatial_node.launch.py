...
def generate_launch_description():
    ...
    tracker_yolov4_spatial_node = launch_ros.actions.Node(
            ...
            output='screen',
            remappings=[('/color/camera_info', '/summit/arm_camera/color/camera_info'), ('/color/image', '/summit/arm_camera/color/image'), ('/stereo/depth', '/summit/arm_camera/stereo/depth'), ('/stereo/camera_info', '/summit/arm_camera/stereo/camera_info'),],
